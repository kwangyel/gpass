...
class movementController{
    ...
    static async create(req,res){
        ...
        try{
            const item = await movementService.create(data)
    ...
    static async retrieve(req,res){
        ...
        try{
            const item = await movementService.retrieve(id)
            if(item){
    ...
    static async update(req,res){
        ...
        try{
            const item = await movementService.update(id,data)
            if(item[0]==1){
    ...
    static async delete(req,res){
        ...
        try{
            const item = await movementService.delete(id)
            if(item){
