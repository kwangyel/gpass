import requestService from '../services/requestSerivce'
...
class requestController{
    ...
    static async create(req,res){
        ...
        try{
            const item = await requestService.create(data)
    ...
    static async retrieve(req,res){
        ...
        try{
            const item = await requestService.retrieve(id)
            if(item){
    ...
    static async update(req,res){
        ...
        try{
            const item = await requestService.update(id,data)
            if(item[0]==1){
    ...
    static async delete(req,res){
        ...
        try{
            const item = await requestService.delete(id)
            if(item){
